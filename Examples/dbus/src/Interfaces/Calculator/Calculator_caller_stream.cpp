...
Calculator_caller_stream::Calculator_caller_stream(Calculator &pcomp)
    : Caller_stream(), comp(pcomp) {
  return;
}

bool Calculator_caller_stream::call(CompoMe::Function_stream_recv &is,
...
bool Calculator_caller_stream::call(std::string &name_function,
...
bool Calculator_caller_stream::add(CompoMe::Function_stream_recv &is,
                                   CompoMe::Return_stream_send &os) {
...
bool Calculator_caller_stream::sub(CompoMe::Function_stream_recv &is,
                                   CompoMe::Return_stream_send &os) {
...
bool Calculator_caller_stream::time(CompoMe::Function_stream_recv &is,
                                    CompoMe::Return_stream_send &os) {
...
bool Calculator_caller_stream::div(CompoMe::Function_stream_recv &is,
                                   CompoMe::Return_stream_send &os) {
