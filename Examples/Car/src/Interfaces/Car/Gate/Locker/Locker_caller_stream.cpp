...
Locker_caller_stream::Locker_caller_stream(Locker &pcomp)
    : Caller_stream(), comp(pcomp) {
  return;
}

bool Locker_caller_stream::call(CompoMe::Function_stream_recv &is,
...
bool Locker_caller_stream::call(std::string &name_function,
...
bool Locker_caller_stream::open_window(CompoMe::Function_stream_recv &is,
                                       CompoMe::Return_stream_send &os) {
...
bool Locker_caller_stream::close_window(CompoMe::Function_stream_recv &is,
                                        CompoMe::Return_stream_send &os) {
...
bool Locker_caller_stream::state(CompoMe::Function_stream_recv &is,
                                 CompoMe::Return_stream_send &os) {
