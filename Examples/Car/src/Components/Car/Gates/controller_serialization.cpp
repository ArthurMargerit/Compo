...
std::ostream &
controller::to_stream_provide(std::ostream &os,
                              Serialization_context_export &p_ctx) const {
  os << ",provide:{";
...
//                            LOAD/SAVE                                    //
/////////////////////////////////////////////////////////////////////////////
std::ostream &controller::to_stream(std::ostream &os,
                                    Serialization_context_export &p_ctx) const {
  os << "{";
  os << "addr:" << (void *)this;
  p_ctx.declare(this);
...
std::istream &controller::from_stream_sc(std::istream &is,
                                         Serialization_context_import &p_ctx) {
  char l_c = is.get();
  if (l_c != '{') {
    std::cerr << "Wrong start: '" << l_c << "' != '{'";
...
std::istream &controller::from_stream(std::istream &is,
                                      Serialization_context_import &p_ctx) {
  controller l_reset;
  *this = l_reset;
