...
Information_I_caller_stream::Information_I_caller_stream(Information_I &pcomp)
    : Caller_stream(), comp(pcomp) {
  return;
}

bool Information_I_caller_stream::call(CompoMe::Function_stream_recv &is,
...
bool Information_I_caller_stream::call(std::string &name_function,
...
bool Information_I_caller_stream::get_name(CompoMe::Function_stream_recv &is,
                                           CompoMe::Return_stream_send &os) {
...
bool Information_I_caller_stream::get_type(CompoMe::Function_stream_recv &is,
                                           CompoMe::Return_stream_send &os) {
...
bool Information_I_caller_stream::get_location(
...
void Information_I_caller_stream::introspection(std::ostream &ss) {
