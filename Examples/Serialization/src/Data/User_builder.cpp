...
User_builder &User_builder::set_id(const int &p_id) {
  this->id = p_id;
  return *this;
}

User_builder &User_builder::set_first_name(const string &p_first_name) {
  this->first_name = p_first_name;
  return *this;
}

User_builder &User_builder::set_last_name(const string &p_last_name) {
