...
void Link_out::set_out(Interface **pfrom,Build_fake_F& bf) {}
void Link_array_in::set_in(unsigned int p_id, Interface *pto) {}
void Link_array_out::set_out(unsigned int p_id, Interface **pfrom, Build_fake_F& bf) {}
void Link_map_in::set_in(std::string p_key, Interface *pto) {}
void Link_map_out::set_out(std::string p_key, Interface **pfrom, Build_fake_F& bf) {}
