...
echo "__CORE__"
./run_before.sh cpp_before/CompoMe cpp_before/CompoMe_Async cpp_before/CompoMe_Log cpp_before/CompoMe_Swig cpp_before/CompoMe_Test cpp_before/CompoMe_Tools
