...
public:
  Function_json_recv_i() { this->get_data()["jsonrpc"] = "2.0"; }
  void pull() override {}
  void end() override {}

  void set_id(i32 p_id) { this->get_data()["id"] = p_id; }
  void set_function(std::string p_func) {
    this->get_data()["function"] = p_func;
  }
};
...
public:
  ...
  Return_json_send_i(Function_json_recv_i &r) : msg(r) {
    this->get_data()["id"] = this->msg.get_data()["id"];
...
TEST_CASE("A caller Interface json", "[Interface][JSON][caller]") {
  ...
  re.get_data()["result"].get_to(i);
  REQUIRE(i == 0);

  fe.set_function("set_a1");
  fe.get_data()["params"] = nlohmann::json::array({1});
  REQUIRE(e_c->call(fe, re) == true);
  ...
  fe.set_function("set_a1");
  fe.get_data()["params"] = nlohmann::json::array({2});
  REQUIRE(e_c->call(fe, re) == true);
...
TEST_CASE("B caller Interface json", "[Interface][json][caller]") {
  ...
  SECTION("F1 empty object") {
    fe.set_function("f1");
    fe.get_data()["params"] = nlohmann::json::object();
    REQUIRE(e_c->call(fe, re) == true);
    i32 i = 0;
    re.get_data()["result"].get_to(i);
    REQUIRE(i == 42);
  ...
  SECTION("F1 empty array ") {
    fe.set_function("f1");
    fe.get_data()["params"] = nlohmann::json::array();
    REQUIRE(e_c->call(fe, re) == true);
    i32 i = 0;
    re.get_data()["result"].get_to(i);
    REQUIRE(i == 42);
  ...
  SECTION("F2 array") {
    fe.set_function("f2");
    fe.get_data()["params"] = nlohmann::json::array({0});
    fe.get_data()["params"][0] = 5;
    REQUIRE(e_c->call(fe, re) == true);
    i32 i = 0;
    re.get_data()["result"].get_to(i);
    REQUIRE(i == 5);
  ...
  SECTION("F3 object") {
    fe.set_function("f3");
    fe.get_data()["params"]["p1"] = (i32)5;
    fe.get_data()["params"]["p2"] = (i32)15;
    REQUIRE(e_c->call(fe, re) == true);
    i32 i = 0;
    re.get_data()["result"].get_to(i);
    REQUIRE(i == 15 + 5);
  ...
  SECTION("F3 array") {
    fe.set_function("f3");
    fe.get_data()["params"] = nlohmann::json::array({0, 0});
    fe.get_data()["params"][0] = (i32)5;
    fe.get_data()["params"][1] = (i32)15;
    REQUIRE(e_c->call(fe, re) == true);
    i32 i = 0;
    re.get_data()["result"].get_to(i);
    REQUIRE(i == 15 + 5);
...
TEST_CASE("C caller Interface json", "[Interface][JSON][caller]") {
  ...
  SECTION("F0 ") {
    ...
    S1 s_out;
    REQUIRE(e_c->call(fe, re) == true);
    s_out.from_json(re.get_data()["result"], i);
  ...
  SECTION("F1 object") {
    ...
    S1 s_in;
    s_in.to_json(fe.get_data()["params"]["a"], i);
    REQUIRE(e_c->call(fe, re) == true);
  }
  ...
  SECTION("F1 array") {
    ...
    CompoMe::Serialization_context_export i;
    S1 s_in;
    fe.get_data()["params"] = nlohmann::json::array({nullptr});
    s_in.to_json(fe.get_data()["params"][0], i);
    REQUIRE(e_c->call(fe, re) == true);
  }
  ...
  SECTION("F2 object") {
    ...
    s_in.to_json(fe.get_data()["params"]["b"], i_e);
    REQUIRE(e_c->call(fe, re) == true);
    s_out.from_json(re.get_data()["result"], i_i);
  ...
  SECTION("F2 array") {
    ...
    CompoMe::Serialization_context_export i_e;
    fe.get_data()["params"] = nlohmann::json::array({nullptr});
    s_in.to_json(fe.get_data()["params"][0], i_e);
    REQUIRE(e_c->call(fe, re) == true);
    s_out.from_json(re.get_data()["result"], i_i);
  ...
  SECTION("F2 object") {
    ...
    CompoMe::Serialization_context_import i_i;
    CompoMe::Serialization_context_export i_e;
    s_in1.to_json(fe.get_data()["params"]["a"], i_e);
    s_in2.to_json(fe.get_data()["params"]["b"], i_e);
  ...
  SECTION("F2 array") {
    ...
    CompoMe::Serialization_context_import i_i;
    CompoMe::Serialization_context_export i_e;
    fe.get_data()["params"] = nlohmann::json::array({nullptr, nullptr});

    s_in1.to_json(fe.get_data()["params"][0], i_e);
    s_in2.to_json(fe.get_data()["params"][1], i_e);
